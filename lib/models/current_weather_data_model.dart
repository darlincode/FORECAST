...
class CurrentWeatherData extends Entity<CurrentWeatherData> {
  ...
  factory CurrentWeatherData.createEmpty() => CurrentWeatherData(
  ...
  @override
  CurrentWeatherData.fromJson(json)
      : lastUpdated =
